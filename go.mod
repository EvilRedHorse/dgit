module github.com/EvilRedHorse/dgit

go 1.13

replace (
	github.com/99designs/keyring => github.com/quorumcontrol/keyring v1.1.5-0.20200324201224-62c57642bc6f
	github.com/EvilRedHorse/go-pubaccess => github.com/quorumcontrol/go-pubaccess v0.0.2
...
require (
	...
	github.com/EvilRedHorse/go-pubaccess v0.0.2
